/**
 * Read-only view for the Auto Trade tab: currently open/recently closed
 * bot positions (joined with today's price/score, same shape as
 * swing-watchlist.js's positions) plus the recent activity log — the
